...
const tld = '.dataset';
const CONTRACT_ADDRESS = '0xE762039E158Ffb0F895EEd9ABA8954a0FE3A7a75';
...
const App = () => {
  ...
  const switchNetwork = async () => {
	if (window.ethereum) {
		try {
			// Try to switch to matic mainnet
...
const updateDomain = async () => {
	...
	const renderNotConnectedContainer = () => (
		<div className="connect-wallet-container">
			<img src="https://github.com/ries9112/NFTs-hicetnunc/blob/master/data_name_service.png?raw=true" alt="latest activity" />
		...
		return (
			<div className="form-container">
				...
				<input
					type="text"
					value={record}
					placeholder='where is the dataset?'
...
const editRecord = (name) => {
	...
	return (
		<div className="App">
			<div className="container">
				<div className="header-container">
					<header>
						<div className="left">
						<p className="title">📊👤 Dataset Name Service</p>
						</div>
        ...
        {mints && renderMints()}
          ...
          <a
						className="footer-text"
						href={"https://twitter.com/Esclaponr"}
						target="_blank"
						rel="noreferrer"
					>{"by Ricky"}</a> 
				</div>
